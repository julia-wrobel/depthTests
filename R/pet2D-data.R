...
##'
##' Simulated two-dimensional PET imaging data. The original data is proprietery, but consists of images from
...
##' matrix of simulated PET data. Each column is a vector for one subject which represents a 95 x 79 pixel image. To view the image for the ith
##' column, use image.i = matrix(pet2D[,i], nrow = 95, ncol = 79) and image(image.i). There are 50 subjects in total.}
##' }
